(function ($) {
    ...
    setTimeout(() => {
        let isNotifOpened = document.querySelector("#notification-opened").style.display == 'block';
        if(!isNotifOpened){
            $(init);
        };
        // console.log(isNotifOpened)
    },3000)
    ...
    function addFlake(initial)
    {
        ...
        var sizes = [
            ...
            },
            {
                r: 0.1,
                css: {
                    fontSize: 150 + Math.floor(Math.random() * 40) + 'px',
