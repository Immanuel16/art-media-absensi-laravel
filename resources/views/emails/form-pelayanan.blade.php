@component('mail::message')
    ...
    <div style="width:100%;height:3px;background-color:rgba(10, 65, 105, 0.5);margin-top:15px;margin-bottom: 15px"></div>
<p style="font-size: 1.25em;font-weight:670;color:#000">
    Shalom <span style="font-style: oblique;text-transform:capitalize">{{ $dataEmail['fullname'] }}</span>,
</p>
<p style="font-size: 1em;font-weight:500;color:#000">
    Terima kasih untuk waktunya sudah mengisi Form Pelayanan di bulan Januari 2022 dan Tahun Baru.
</p>
<p style="font-size: 1em;font-weight:500;color:#000">
...
<table border="0" align="left" style="width:100%;margin-bottom:45px">
    <tr style="font-size: 1em;font-weight:500;color:rgb(11, 133, 9);">
